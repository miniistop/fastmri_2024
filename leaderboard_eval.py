    ...
    with torch.no_grad():
        for i_subject in range(58):
            ...
            for i_slice in range(num_slices):
                ...
                ssim_item = ssim_calculator(recon*mask, target*mask, maximum).cpu().numpy()
...
#     args = parser.parse_args()
    ...
    hr_min_sec_print("total_test", acc8_time)
    
    score = (SSIM_acc4 + SSIM_acc8) / 2
    print(f"=====================================================================================" )
    print(f"||   Leaderboard Dataset SSIM : {score:.4f}   ||   ACC4 : {SSIM_acc4:.4f}   ||   ACC8 : {SSIM_acc8:.4f}   ||")
    print(f"=====================================================================================" )
    return score
