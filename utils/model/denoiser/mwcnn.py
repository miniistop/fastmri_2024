...
from denoiser import common
#DWT, IWT, BBlock, DBlock_com, DBlock_com1, DBlock_inv, DBlock_inv1, default_conv, default_conv1
...
class MWCNN(nn.Module):
    def __init__(self,conv=common.default_conv):
        ...
        n_resblocks = 3 #args.n_resblocks
        n_feats =32 # args.n_feats
        kernel_size = 3
        self.scale_idx = 0
        nColor = 2
